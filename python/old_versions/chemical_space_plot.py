...
def main():
    ...
    data = pickle.load(open('/home/gah/oprd/data/oprd_mapped_cores_ECFP_512.pkl',"rb"))
    
    fingerprints =  _np_to_vectorUintd(data.iloc[:,0:-2]) # remember to change this to data[0] for drfps
